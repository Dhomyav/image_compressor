...
public class MainActivity extends AppCompatActivity {
    ...
    TextView txtOriginal, txtCompresssed, txtQuality;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtCompresssed = findViewById(R.id.txtCompressed);
            ...
            public void onClick(View view) {
                ...
                try {
                    compressedImage = new Compressor(MainActivity.this)
                            .setMaxWidth(width).setMaxHeight(height).setQuality(quality)
                    ...
                    txtCompresssed.setText("Size: " + Formatter.formatShortFileSize(MainActivity.this, finalFile.length()));
